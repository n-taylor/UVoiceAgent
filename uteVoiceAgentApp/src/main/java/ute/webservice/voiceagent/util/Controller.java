...
//        displayClientLocation("f8:34:41:bf:ab:ee", context); // Hardcoded mac address for testing with an emulator
        ...
        LocationController.getInstance().displayClientLocation(getMacAddr().toLowerCase(Locale.US), context); // This line for use without an emulator
...
//        LocationController.getInstance().findTags(activity, getMacAddr().toLowerCase(Locale.US), "Infusion");
    }
